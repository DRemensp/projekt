...
7. Schul-Score = Summe der Top-N-Team-Scores pro Schule, wobei N entweder automatisch ermittelt wird (kleinste Teamanzahl aller Schulen) oder manuell über `school_teams_override` im Scoresystem überschrieben werden kann. So wird sichergestellt, dass Schulen mit unterschiedlich vielen Teams fair verglichen werden.
