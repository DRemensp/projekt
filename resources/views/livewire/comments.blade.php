...
<div class="max-w-3xl mx-auto my-8">
    ...
    {{-- Moderation Button: immer sichtbar für Admin & Teacher --}}
    @auth
    ...
    @if(isset($comments) && $comments->count() > 0)
        <div class="space-y-4">
            <div class="flex justify-between items-center">
                <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-100 flex items-center gap-2" wire:poll.60s>
