<x-layout>
    ...
    <style>
        ...
        .dark .light-mode-only { display: none; }
        ...
        .aurora-sky {
            background:
                radial-gradient(1200px circle at 12% 0%, rgba(45, 212, 191, 0.18), transparent 60%),
        ...
        .dark .delay-1 { animation-delay: 0.1s; }
        .dark .delay-2 { animation-delay: 0.2s; }
        .dark .delay-3 { animation-delay: 0.3s; }
        .dark .delay-4 { animation-delay: 0.4s; }
            ...
            <div class="container mx-auto px-4 relative z-10">
                <div class="flex flex-col items-center text-center">
                    ...
                    <div class="flex flex-wrap justify-center gap-4 mb-16">
                        <a href="{{ url('/ranking') }}" class="inline-flex items-center gap-2 px-8 py-3 bg-indigo-600 text-white text-base font-medium rounded-lg shadow-md hover:bg-indigo-700 hover:shadow-xl hover:-translate-y-1 transition-all duration-200">
                        ...
                        <a href="{{ url('/login') }}" class="inline-flex items-center gap-2 px-8 py-3 bg-white text-indigo-600 text-base font-medium rounded-lg border border-indigo-300 shadow-sm hover:bg-indigo-50 hover:shadow-lg hover:-translate-y-1 transition-all duration-200">
                    ...
                    <div class="w-full max-w-6xl mx-auto relative">
                        <div class="overflow-hidden rounded-xl">
                            <div id="slideshow-container-light" class="flex transition-transform duration-500 ease-in-out">
                                <!-- Slide 1 -->
                                <div class="w-full md:w-1/3 flex-shrink-0 px-2">
                                    <div class="bg-white p-5 rounded-lg shadow-md border border-gray-100 flex flex-col items-center text-center h-full">
                                        <div class="w-12 h-12 bg-indigo-100 rounded-full flex items-center justify-center mb-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-indigo-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="7"></circle><polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"></polyline></svg>
                                        </div>
                                        <h3 class="text-lg font-semibold text-gray-800 mb-2">🏆 Ranking & Live Auswertung</h3>
                                ...
                                <div class="w-full md:w-1/3 flex-shrink-0 px-2">
                                    <div class="bg-white p-5 rounded-lg shadow-md border border-gray-100 flex flex-col items-center text-center h-full">
                                        ...
                                        <h3 class="text-lg font-semibold text-gray-800 mb-2">⚙️ Verwaltung & Stammdaten</h3>
                                        <ul class="space-y-2 text-left text-sm text-gray-600">
                                ...
                                <div class="w-full md:w-1/3 flex-shrink-0 px-2">
                                    <div class="bg-white p-5 rounded-lg shadow-md border border-gray-100 flex flex-col items-center text-center h-full">
                                        <div class="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mb-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-blue-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"></path><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"></path></svg>
                                        </div>
                                ...
                                <div class="w-full md:w-1/3 flex-shrink-0 px-2">
                                    <div class="bg-white p-5 rounded-lg shadow-md border border-gray-100 flex flex-col items-center text-center h-full">
                                        <div class="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center mb-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-green-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9.75L12 4l9 5.75V20a1 1 0 0 1-1 1h-5.25a.75.75 0 0 1-.75-.75V13.5h-4.5v6.75a.75.75 0 0 1-.75.75H4a1 1 0 0 1-1-1Z"></path></svg>
                                        </div>
                                ...
                                <div class="w-full md:w-1/3 flex-shrink-0 px-2">
                                    <div class="bg-white p-5 rounded-lg shadow-md border border-gray-100 flex flex-col items-center text-center h-full">
                                        <div class="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center mb-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-purple-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 4h6a2 2 0 0 1 2 2v14l-5-3-5 3V6a2 2 0 0 1 2-2Z"></path></svg>
                                        </div>
                                ...
                                <div class="w-full md:w-1/3 flex-shrink-0 px-2">
                                    <div class="bg-white p-5 rounded-lg shadow-md border border-gray-100 flex flex-col items-center text-center h-full">
                                        <div class="w-12 h-12 bg-amber-100 rounded-full flex items-center justify-center mb-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-amber-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 7h18M7 7V5a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v2m-8 8h6M5 7v13a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V7"></path></svg>
                                        </div>
                        ...
                        <div class="flex justify-center mt-6 space-x-2">
                            <button class="slide-indicator-light w-2.5 h-2.5 rounded-full bg-indigo-600 transition-all" data-slide="0"></button>
                            <button class="slide-indicator-light w-2.5 h-2.5 rounded-full bg-gray-300 transition-all" data-slide="1"></button>
                            <button class="slide-indicator-light w-2.5 h-2.5 rounded-full bg-gray-300 transition-all" data-slide="2"></button>
                            <button class="slide-indicator-light w-2.5 h-2.5 rounded-full bg-gray-300 transition-all" data-slide="3"></button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="py-12 md:py-16 bg-gradient-to-br from-slate-50 to-gray-100 border-t border-gray-200">
            <div class="container mx-auto px-4">
                <div class="text-center mb-8 md:mb-12">
                    ...
                    <p class="text-base md:text-lg text-gray-600 max-w-2xl mx-auto">Live Zahlen zur Campus Olympiade im Überblick</p>
                </div>
                    ...
                    <a href="{{ url('/ranking') }}" class="bg-white rounded-xl md:rounded-2xl shadow-lg p-4 md:p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group block">
                        <div class="flex flex-col items-center text-center">
                            <div class="w-12 h-12 md:w-16 md:h-16 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-xl md:rounded-2xl flex items-center justify-center mb-3 md:mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                                <svg class="w-6 h-6 text-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-width="2.2" d="M8 20v-9l-4 1.125V20h4Zm0 0h8m-8 0V6.66667M16 20v-9l4 1.125V20h-4Zm0 0V7m0 0V4h4v3h-4ZM6 8l6-4 4 2.66667M11 9h2m-2 3h2"/></svg>
                            </div>
                    ...
                    <a href="{{ url('/ranking') }}" class="bg-white rounded-xl md:rounded-2xl shadow-lg p-4 md:p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group block">
                        <div class="flex flex-col items-center text-center">
                            <div class="w-12 h-12 md:w-16 md:h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl md:rounded-2xl flex items-center justify-center mb-3 md:mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                                <svg class="w-6 h-6 text-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-width="2" d="M4.5 17H4a1 1 0 0 1-1-1 3 3 0 0 1 3-3h1m0-3.05A2.5 2.5 0 1 1 9 5.5M19.5 17h.5a1 1 0 0 0 1-1 3 3 0 0 0-3-3h-1m0-3.05a2.5 2.5 0 1 0-2-4.45m.5 13.5h-7a1 1 0 0 1-1-1 3 3 0 0 1 3-3h3a3 3 0 0 1 3 3 1 1 0 0 1-1 1Zm-1-9.5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Z"/></svg>
                            </div>
                    ...
                    <a href="{{ url('/ranking') }}" class="bg-white rounded-xl md:rounded-2xl shadow-lg p-4 md:p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group block">
                        <div class="flex flex-col items-center text-center">
                            <div class="w-12 h-12 md:w-16 md:h-16 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-xl md:rounded-2xl flex items-center justify-center mb-3 md:mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                                <svg class="w-6 h-6 text-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-width="2" d="M16 19h4a1 1 0 0 0 1-1v-1a3 3 0 0 0-3-3h-2m-2.236-4a3 3 0 1 0 0-4M3 18v-1a3 3 0 0 1 3-3h4a3 3 0 0 1 3 3v1a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1Zm8-10a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"/></svg>
                            </div>
                    ...
                    <a href="{{ url('/ranking') }}" class="bg-white rounded-xl md:rounded-2xl shadow-lg p-4 md:p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group block">
                        <div class="flex flex-col items-center text-center">
                            <div class="w-12 h-12 md:w-16 md:h-16 bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl md:rounded-2xl flex items-center justify-center mb-3 md:mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                                <svg class="w-6 h-6 text-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-width="2" d="M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0 0a8.949 8.949 0 0 0 4.951-1.488A3.987 3.987 0 0 0 13 16h-2a3.987 3.987 0 0 0-3.951 3.512A8.948 8.948 0 0 0 12 21Zm3-11a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"/></svg>
                            </div>
                ...
                <div class="max-w-sm mx-auto">
                    <div class="bg-white/70 rounded-lg shadow-sm p-3 border border-gray-200/50 text-center">
                        <div class="flex items-center justify-center gap-2 text-gray-600">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
                            <span class="text-sm"><strong class="text-purple-600">{{ number_format($visitcount->total_visits ?? 0) }}</strong> Besuche insgesamt</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="dark-mode-only relative z-0 min-h-screen overflow-x-hidden">
        ...
        <section class="relative overflow-hidden py-16 md:py-24">
            ...
            <div class="container mx-auto px-4 relative z-10">
                <div class="grid lg:grid-cols-[1.1fr,0.9fr] gap-12 items-center">
                    <div class="space-y-8">
                        <div class="hero-kicker reveal inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-slate-900/70 border border-white/25 text-slate-400 uppercase tracking-[0.25em] text-[0.7rem]">
                        ...
                        <div class="space-y-4">
                            <h1 class="display-font text-5xl md:text-7xl font-semibold leading-tight reveal delay-1">
                                Campus Olympiade
                                <span class="block text-transparent bg-clip-text bg-gradient-to-r from-teal-300 via-sky-300 to-amber-200">Live. Fair. Schnell.</span>
                            </h1>
                            <p class="text-lg md:text-xl text-slate-300 max-w-xl reveal delay-2">
                                Das Wettbewerbszentrum für Schulen, Klassen und Teams. Rankings in Echtzeit, klare Workflows, starke Community.
                            </p>
                        </div>
                        <div class="flex flex-wrap gap-4 reveal delay-3">
                            <a href="{{ url('/ranking') }}" class="cta-primary relative isolate overflow-hidden inline-flex items-center gap-3 px-8 py-3.5 rounded-full text-[#0a0f14] font-bold shadow-[0_12px_30px_rgba(45,212,191,0.35)] transition-all duration-300 hover:-translate-y-0.5 hover:scale-[1.01] hover:shadow-[0_18px_40px_rgba(45,212,191,0.45)]">
                                <span class="relative z-10">Ranking live</span>
                                <svg class="relative z-10 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <circle cx="12" cy="8" r="7"></circle>
                                    <polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"></polyline>
                                </svg>
                            </a>
                            <a href="{{ url('/login') }}" class="inline-flex items-center gap-3 px-8 py-3.5 rounded-full border border-blue-400/45 bg-slate-900/65 text-slate-100 transition-all duration-300 hover:-translate-y-0.5 hover:border-blue-400/80 hover:shadow-[0_12px_28px_rgba(12,18,30,0.6)]">
                        ...
                        <div class="flex flex-wrap gap-3 text-sm text-slate-300 reveal delay-4">
                            <span class="tag-chip px-3.5 py-1.5 rounded-full bg-slate-900/70 border border-white/20">Echtzeit Rankings</span>
                            <span class="tag-chip px-3.5 py-1.5 rounded-full bg-slate-900/70 border border-white/20">Automatische Scores</span>
                            <span class="tag-chip px-3.5 py-1.5 rounded-full bg-slate-900/70 border border-white/20">Moderation bereit</span>
                        </div>
                    </div>

                    <div class="relative reveal delay-2">
                        <div class="scoreboard-panel rounded-[32px] border border-white/20 p-8 shadow-[0_30px_80px_rgba(4,6,12,0.7)] backdrop-blur-xl">
                            <div class="flex items-center justify-between text-xs uppercase tracking-[0.3em] text-slate-400">
                                <span>Live Teilnehmer</span>
                                <span class="tag-chip tag-muted bg-slate-900/40 uppercase tracking-[0.08em] text-[0.7rem] px-3.5 py-1.5 rounded-full border border-white/20">Now</span>
                            </div>
                            <div class="mt-6 grid grid-cols-2 gap-4">
                                <div class="score-cell bg-[rgba(12,18,30,0.9)] border border-white/[0.18] rounded-[18px] p-4 relative overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:border-teal-400/35">
                            ...
                            <div class="mt-6 flex items-center justify-between border-t border-white/10 pt-4">
                                ...
                                <div class="display-font text-2xl text-amber-200">{{ number_format($visitcount->total_visits ?? 0) }}</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container mx-auto px-4">
                <div class="flex flex-col lg:flex-row items-start justify-between gap-8">
                    <div class="space-y-4 max-w-2xl">
                        ...
                        <p class="text-slate-300">Von der Punktaufnahme bis zum Archiv bleibt jedes Team sichtbar. Klar, schnell, professionell.</p>
                    </div>
                    <div class="flex gap-3">
                        <a href="{{ url('/ranking') }}" class="inline-flex items-center gap-3 px-8 py-3.5 rounded-full border border-blue-400/45 bg-slate-900/65 text-slate-100 transition-all duration-300 hover:-translate-y-0.5 hover:border-blue-400/80 hover:shadow-[0_12px_28px_rgba(12,18,30,0.6)]">Zum Ranking</a>
                    </div>
                </div>
                ...
                <div class="mt-10 module-carousel-shell">
                    <div class="module-carousel grid md:grid-cols-2 lg:grid-cols-3 gap-6" data-module-carousel>
                        <div class="module-card reveal border border-white/20 rounded-3xl p-7 shadow-[0_20px_50px_rgba(4,6,12,0.5)] transition-all duration-[400ms] hover:-translate-y-2 hover:border-teal-400/45 hover:shadow-[0_28px_60px_rgba(4,6,12,0.6)]" data-module-card>
                        <div class="module-icon mb-5 w-12 h-12 rounded-2xl grid place-items-center bg-slate-900/75 border border-white/25">
                        ...
                        <p class="text-slate-400">Live Ranglisten für Schulen, Klassen und Teams mit sofortigen Updates.</p>
                        <div class="mt-4 flex flex-wrap gap-2">
                            <span class="tag-chip tag-muted bg-slate-900/40 uppercase tracking-[0.08em] text-[0.7rem] px-3.5 py-1.5 rounded-full border border-white/20">Filter</span>
                            <span class="tag-chip tag-muted bg-slate-900/40 uppercase tracking-[0.08em] text-[0.7rem] px-3.5 py-1.5 rounded-full border border-white/20">Suche</span>
                            <span class="tag-chip tag-muted bg-slate-900/40 uppercase tracking-[0.08em] text-[0.7rem] px-3.5 py-1.5 rounded-full border border-white/20">Auto</span>
                        </div>
                    </div>

                    <div class="module-card reveal delay-1 border border-white/20 rounded-3xl p-7 shadow-[0_20px_50px_rgba(4,6,12,0.5)] transition-all duration-[400ms] hover:-translate-y-2 hover:border-teal-400/45 hover:shadow-[0_28px_60px_rgba(4,6,12,0.6)]" data-module-card>
                        <div class="module-icon mb-5 w-12 h-12 rounded-2xl grid place-items-center bg-slate-900/75 border border-white/25">
                            <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path d="M12 6V4m0 2a2 2 0 1 0 0 4m0-4a2 2 0 1 1 0 4m-6 8a2 2 0 1 0 0 4m0-4a2 2 0 1 1 0 4m12-4a2 2 0 1 0 0 4m0-4a2 2 0 1 1 0 4M6 6v10M18 6v10"></path>
                            </svg>
                        </div>
                        <h3 class="display-font text-xl text-slate-100 mb-2">Verwaltung & Stammdaten</h3>
                        <p class="text-slate-400">Disziplinen, Schulen und Teams zentral steuern, inklusive Score-Regeln.</p>
                        <div class="mt-4 flex flex-wrap gap-2">
                            <span class="tag-chip tag-muted bg-slate-900/40 uppercase tracking-[0.08em] text-[0.7rem] px-3.5 py-1.5 rounded-full border border-white/20">Konfig</span>
                            <span class="tag-chip tag-muted bg-slate-900/40 uppercase tracking-[0.08em] text-[0.7rem] px-3.5 py-1.5 rounded-full border border-white/20">Sync</span>
                            <span class="tag-chip tag-muted bg-slate-900/40 uppercase tracking-[0.08em] text-[0.7rem] px-3.5 py-1.5 rounded-full border border-white/20">Admins</span>
                        </div>
                    </div>

                    <div class="module-card reveal delay-2 border border-white/20 rounded-3xl p-7 shadow-[0_20px_50px_rgba(4,6,12,0.5)] transition-all duration-[400ms] hover:-translate-y-2 hover:border-teal-400/45 hover:shadow-[0_28px_60px_rgba(4,6,12,0.6)]" data-module-card>
                        <div class="module-icon mb-5 w-12 h-12 rounded-2xl grid place-items-center bg-slate-900/75 border border-white/25">
                            <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        ...
                        <p class="text-slate-400">Schnelle Eingabe mit Bestleistung-Logik und sofortiger Platzierung.</p>
                        <div class="mt-4 flex flex-wrap gap-2">
                            <span class="tag-chip tag-muted bg-slate-900/40 uppercase tracking-[0.08em] text-[0.7rem] px-3.5 py-1.5 rounded-full border border-white/20">Live</span>
                            <span class="tag-chip tag-muted bg-slate-900/40 uppercase tracking-[0.08em] text-[0.7rem] px-3.5 py-1.5 rounded-full border border-white/20">Teams</span>
                            <span class="tag-chip tag-muted bg-slate-900/40 uppercase tracking-[0.08em] text-[0.7rem] px-3.5 py-1.5 rounded-full border border-white/20">Versuche</span>
                        </div>
                    </div>
                    ...
                    <div class="module-card reveal border border-white/20 rounded-3xl p-7 shadow-[0_20px_50px_rgba(4,6,12,0.5)] transition-all duration-[400ms] hover:-translate-y-2 hover:border-teal-400/45 hover:shadow-[0_28px_60px_rgba(4,6,12,0.6)]" data-module-card>
                        <div class="module-icon mb-5 w-12 h-12 rounded-2xl grid place-items-center bg-slate-900/75 border border-white/25">
                            <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path d="M3 9.75L12 4l9 5.75V20a1 1 0 0 1-1 1h-5.25a.75.75 0 0 1-.75-.75V13.5h-4.5v6.75a.75.75 0 0 1-.75.75H4a1 1 0 0 1-1-1Z"></path>
                            </svg>
                        </div>
                        <h3 class="display-font text-xl text-slate-100 mb-2">Welcome Hub</h3>
                        <p class="text-slate-400">Einstiegspunkt für Stats, Diskussionen und alle Wettbewerbsbereiche.</p>
                        <div class="mt-4 flex flex-wrap gap-2">
                            <span class="tag-chip tag-muted bg-slate-900/40 uppercase tracking-[0.08em] text-[0.7rem] px-3.5 py-1.5 rounded-full border border-white/20">Dashboard</span>
                            <span class="tag-chip tag-muted bg-slate-900/40 uppercase tracking-[0.08em] text-[0.7rem] px-3.5 py-1.5 rounded-full border border-white/20">Live</span>
                            <span class="tag-chip tag-muted bg-slate-900/40 uppercase tracking-[0.08em] text-[0.7rem] px-3.5 py-1.5 rounded-full border border-white/20">Zugriff</span>
                        </div>
                    </div>
                    ...
                    <div class="module-card reveal delay-1 border border-white/20 rounded-3xl p-7 shadow-[0_20px_50px_rgba(4,6,12,0.5)] transition-all duration-[400ms] hover:-translate-y-2 hover:border-teal-400/45 hover:shadow-[0_28px_60px_rgba(4,6,12,0.6)]" data-module-card>
                        ...
                        <p class="text-slate-400">Persönliche Übersicht der Disziplinen, Fortschritte und Ergebnisse.</p>
                        <div class="mt-4 flex flex-wrap gap-2">
                            <span class="tag-chip tag-muted bg-slate-900/40 uppercase tracking-[0.08em] text-[0.7rem] px-3.5 py-1.5 rounded-full border border-white/20">Teams</span>
                            <span class="tag-chip tag-muted bg-slate-900/40 uppercase tracking-[0.08em] text-[0.7rem] px-3.5 py-1.5 rounded-full border border-white/20">Progress</span>
                            <span class="tag-chip tag-muted bg-slate-900/40 uppercase tracking-[0.08em] text-[0.7rem] px-3.5 py-1.5 rounded-full border border-white/20">Ergebnis</span>
                        </div>
                    </div>
                    ...
                    <div class="module-card reveal delay-2 border border-white/20 rounded-3xl p-7 shadow-[0_20px_50px_rgba(4,6,12,0.5)] transition-all duration-[400ms] hover:-translate-y-2 hover:border-teal-400/45 hover:shadow-[0_28px_60px_rgba(4,6,12,0.6)]" data-module-card>
                        <div class="module-icon mb-5 w-12 h-12 rounded-2xl grid place-items-center bg-slate-900/75 border border-white/25">
                            <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path d="M3 7h18M7 7V5a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v2m-8 8h6M5 7v13a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V7"></path>
                            </svg>
                        </div>
                        <h3 class="display-font text-xl text-slate-100 mb-2">Archiv & Historie</h3>
                        <p class="text-slate-400">Vergangene Wettbewerbe, detaillierte Rankings und Vergleichswerte.</p>
                        <div class="mt-4 flex flex-wrap gap-2">
                            <span class="tag-chip tag-muted bg-slate-900/40 uppercase tracking-[0.08em] text-[0.7rem] px-3.5 py-1.5 rounded-full border border-white/20">History</span>
                            <span class="tag-chip tag-muted bg-slate-900/40 uppercase tracking-[0.08em] text-[0.7rem] px-3.5 py-1.5 rounded-full border border-white/20">Stats</span>
                            <span class="tag-chip tag-muted bg-slate-900/40 uppercase tracking-[0.08em] text-[0.7rem] px-3.5 py-1.5 rounded-full border border-white/20">Export</span>
                        </div>
                    </div>
                </div>
                </div>
        ...
        <section class="py-20 relative">
            <div class="container mx-auto px-4">
                <div class="text-center max-w-3xl mx-auto space-y-4 mb-12">
                    ...
                    <p class="text-slate-300">Eingabe, Berechnung und Sichtbarkeit greifen ineinander, damit jede Leistung sofort zählt.</p>
                </div>
                <div class="grid md:grid-cols-3 gap-6">
                    <div class="flow-card reveal border border-white/20 rounded-3xl p-8 shadow-[0_24px_60px_rgba(5,8,15,0.55)]">
                        ...
                        <p class="text-slate-400">Disziplinen und Teams per Schnellmaske aktualisieren, ohne Umwege.</p>
                    </div>
                    <div class="flow-card reveal delay-1 border border-white/20 rounded-3xl p-8 shadow-[0_24px_60px_rgba(5,8,15,0.55)]">
                        <p class="text-sm uppercase tracking-[0.3em] text-slate-400">02</p>
                        <h3 class="display-font text-xl mt-4 mb-3">Scores berechnen</h3>
                        <p class="text-slate-400">Bestleistungen werden sofort bewertet und auf die Rangliste gelegt.</p>
                    </div>
                    <div class="flow-card reveal delay-2 border border-white/20 rounded-3xl p-8 shadow-[0_24px_60px_rgba(5,8,15,0.55)]">
        ...
        <section class="py-20 relative">
            <div class="container mx-auto px-4">
                ...
                <div class="community-shell border border-white/25 rounded-[32px] p-6 shadow-[0_30px_70px_rgba(5,8,15,0.7)]">
                    <livewire:comments />
                </div>
            </div>
        </section>
